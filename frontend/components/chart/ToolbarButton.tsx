...
export function ToolbarTooltip({ label, hover, placement = "bottom" }: ToolbarTooltipProps) {
  return placement === "bottom" ? (
    ...
    >
      ...
      <div className="mt-[6px] whitespace-nowrap rounded-md border border-border bg-[#151a24] px-2 py-1 text-xs font-medium text-fg shadow-lg">
        {label}
      </div>
    </div>
  ) : (
    ...
    >
      ...
      <div className="mr-[6px] whitespace-nowrap rounded-md border border-border bg-[#151a24] px-2 py-1 text-xs font-medium text-fg shadow-lg">
        {label}
      </div>
    </div>
  );
