      ...
      <div className="space-y-1.5">
        {snippets.map((s) => (
          <button
            ...
            title={s.description}
            className="block w-full rounded-md border border-border px-2.5 py-1.5 text-left text-xs text-white transition-colors hover:border-accent hover:bg-accent/10"
          >
            {s.label}
          </button>
        ))}
