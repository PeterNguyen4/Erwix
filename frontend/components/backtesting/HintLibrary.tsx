...
const ENTRY_SNIPPETS: HintSnippet[] = [
  {
    ...
    apply: (config) => addRule(config, "entry_rules", { type: "comparison", indicator: "rsi_14", comparator: "<", value: "30" }),
  },
  {
    label: "Price crosses above SMA 50",
    description: "Enter when close crosses above the 50-period SMA",
    apply: (config) => addRule(config, "entry_rules", { type: "comparison", indicator: "close", comparator: "crosses_above", value: "sma_50" }),
  },
  {
    label: "MACD turns positive",
    description: "Enter when MACD line crosses above 0",
    apply: (config) => addRule(config, "entry_rules", { type: "comparison", indicator: "macd", comparator: "crosses_above", value: "0" }),
  },
];
...
const EXIT_SNIPPETS: HintSnippet[] = [
  {
    ...
    apply: (config) => addRule(config, "exit_rules", { type: "comparison", indicator: "rsi_14", comparator: ">", value: "70" }),
  },
  {
    label: "Price crosses below SMA 50",
    description: "Exit when close crosses below the 50-period SMA",
    apply: (config) => addRule(config, "exit_rules", { type: "comparison", indicator: "close", comparator: "crosses_below", value: "sma_50" }),
  },
];
