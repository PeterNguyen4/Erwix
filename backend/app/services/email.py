...
logger = logging.getLogger("entro.email")
...
async def send_password_reset_email(to: str, reset_url: str) -> None:
    if not settings.has_resend_creds:
        ...
        return
    html = (
        f"<p>We received a request to reset your Entro password.</p>"
    ...
    try:
        await asyncio.to_thread(_send_sync, to, "Reset your Entro password", html)
    except Exception:
