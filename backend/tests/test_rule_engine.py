...
def test_comparison_rule_holds_on__valid_latest_candle_condition():
    rule = StrategyRule(
        left="close", comparator=">", right="100", description="close > 100"
    )
...
def test_gated_rule_requires_both_condition_and_gate():
    condition = StrategyRule(
        left="close", comparator=">", right="100", description="close > 100"
    )
    gate = StrategyRule(
        left="close", comparator="<", right="200", description="close < 200"
    )
...
def test_signal_price_level_long_stop_loss_breach():
    ...
    assert (
        signal_price_level(
            price=94, entry_price=100, stop_loss_price=95, take_profit_price=110
        )
        == "stop_loss"
    )
...
def test_signal_price_level_long_take_profit_breach():
    assert (
        signal_price_level(
            price=111, entry_price=100, stop_loss_price=95, take_profit_price=110
        )
        == "take_profit"
    )
...
def test_signal_price_level_long_no_breach():
    assert (
        signal_price_level(
            price=105, entry_price=100, stop_loss_price=95, take_profit_price=110
        )
        is None
    )
...
def test_signal_price_level_short_stop_loss_breach():
    ...
    assert (
        signal_price_level(
            price=106, entry_price=100, stop_loss_price=105, take_profit_price=90
        )
        == "stop_loss"
    )
...
def test_signal_price_level_short_take_profit_breach():
    ...
    assert (
        signal_price_level(
            price=89, entry_price=100, stop_loss_price=105, take_profit_price=90
        )
        == "take_profit"
    )
...
def test_signal_price_level_none_when_no_entry_price():
    assert (
        signal_price_level(
            price=100, entry_price=None, stop_loss_price=95, take_profit_price=110
        )
        is None
    )
...
def test_signal_price_level_none_when_levels_unset():
    assert (
        signal_price_level(
            price=100, entry_price=100, stop_loss_price=None, take_profit_price=None
        )
        is None
    )
